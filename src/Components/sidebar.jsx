    ...
    render() { 
        return ( <div className="sidebar-main">
            <div className="image-back">
                <div className="sidebar-image" style={{ backgroundImage : `url(${mypic})` }}></div>
            </div>
            ...
            <div className="side-Navs">
                ...
                <div className="nav"> 
                    ...
                    <Link className="menubtn" to={"/projects"}>Projects</Link>
                </div>
                <div className="nav"> 
                    <i className="material-icons nav-icon">call</i>
                    <Link className="menubtn" to={"/contactme"}>Contact Me</Link>
                </div>
            </div>
        </div> );
    }
